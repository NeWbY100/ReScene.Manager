...
/// <summary>
/// The "Help" region every converted task view carries (spec §2). Behaves as a plain
...
/// ExpandCollapse pattern in both modes, and an AT can INVOKE it (final review: non-focusable is
